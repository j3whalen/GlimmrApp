package java.com.bourke.glimmr.fragments.viewer;
...
import com.bourke.glimmr.fragments.viewer.*;
        ...
        GlimmrPagerAdapter adapter = new GlimmrPagerAdapter(
            ...
            public Fragment getItemImpl(int position) {
                switch (position) {
                    ...
                    case MORE_PAGE:
                        return com.bourke.glimmr.fragments.viewer.ExifInfoFragment.newInstance(
                                PhotoInfoFragment.this.mPhoto);
                }
                return null;
            }
