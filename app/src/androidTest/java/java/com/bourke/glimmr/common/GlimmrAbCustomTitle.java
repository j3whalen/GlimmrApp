...
public class GlimmrAbCustomTitle {
    ...
    private final com.bourke.glimmr.common.TextUtils mTextUtils;

    public GlimmrAbCustomTitle(BaseActivity a) {
        mActivity = a;
        mTextUtils = new com.bourke.glimmr.common.TextUtils(a.getAssets());
    }
    ...
    public void init(ActionBar actionbar) {
        ...
        mTextUtils.setFont(abTitle, com.bourke.glimmr.common.TextUtils.FONT_SHADOWSINTOLIGHT);
